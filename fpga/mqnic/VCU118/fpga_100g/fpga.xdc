...
set_property -dict {LOC R9} [get_ports qsfp2_mgt_refclk_0_p]
...
add_cells_to_pblock [get_pblocks pblock_slr1] [get_cells -quiet [list core_inst/dma_if_mux_inst core_inst/dma_if_pcie_us_inst {core_inst/iface[0].interface_inst/event_queue_manager_inst} {core_inst/iface[1].interface_inst/event_queue_manager_inst} pcie4_uscale_plus_inst core_inst/dma_if_pcie_us_inst/dma_if_pcie_us_rd_inst]]
